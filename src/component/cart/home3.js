...
export function Homepage3(product = {}, container, products = []) {
    ...
    return El({
        ...
        className: "p-5",
        children: [
            El({ element: "img", src: imgSrc, className: "w-full h-64 object-cover rounded-xl" }),
            El({ element: "h1", innerText: name, className: "text-2xl font-bold mt-4" }),
            El({
                element: "div",
            ...
            El({ element: "p", innerText: price, className: "text-gray-700 text-xl mt-2" }),
            El({ element: "p", innerText: `Brand: ${brand}`, className: "text-gray-600 mt-2" }),
            El({
                element: "button",
                innerText: "Back",
